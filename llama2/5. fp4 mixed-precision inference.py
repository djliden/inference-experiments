...
# MAGIC %md
# MAGIC # fp4 mixed-precision inference
# MAGIC
# MAGIC Using [`load_in_4bit=True`](https://huggingface.co/docs/transformers/perf_infer_gpu_one#running-fp4-models-single-gpu-setup-quickstart). Compare to the baseline performance [here](https://e2-dogfood.staging.cloud.databricks.com/?o=6051921418418893#notebook/418210139975057).
# MAGIC
# MAGIC - Low memory usage; reduced speed compared to baseline but faster than int8
