...
# MAGIC %md
# MAGIC # model.to_bettertransformer()
# MAGIC
# MAGIC Using [`model.to_bettertransformer()`](https://huggingface.co/docs/transformers/perf_infer_gpu_one#decoder-models). Compare to the baseline performance [here](https://e2-dogfood.staging.cloud.databricks.com/?o=6051921418418893#notebook/418210139975057).
